...
% Date: 11/14/2021
% Description:  This script generates Figure 6.
%               We consider a 7-dimensional nonlinear spacecraft model and
%               we compute two approximations of the systems reachable set
%               by applying Corolary 1 with two different system
%               represenations.
